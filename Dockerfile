...
FROM ly-union-registry.cn-beijing.cr.aliyuncs.com/taishan/alpine-builder:latest AS builder
...
FROM ly-union-registry.cn-beijing.cr.aliyuncs.com/taishan/alpine3.13:timezone AS final
